  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: const Icon(Icons.add, color: DT.iconGrey, size: 20),
              ),
            ),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            _DailyChallengeCard(onTap: () => context.pushNamed('daily')),
...
class _DailyChallengeCard extends ConsumerStatefulWidget {
  ...
  const _DailyChallengeCard({super.key, required this.onTap});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    return _DailyChallengeCardState();
  }
}
...
class _DailyChallengeCardState extends ConsumerState<_DailyChallengeCard> {
  ...
  @override
  Widget build(BuildContext context) {
    final dailyCheckerProvider = ref.watch(dailyCheckProvider);

    return dailyCheckerProvider.when(
      data: (profileInfo) {
        final data = profileInfo;
        return InkWell(
          onTap: data ? widget.onTap : () {},
          child: Container(
                    ...
                    children: [
                      ...
                      Text(
                        data
                            ...
                            : "Congratulations! You have completed your daily challenge!",
